...
class CommunityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('organization.community.index', compact('posts'));
    }
    ...
    {
        return view('organization.community.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('organization.community.index')
    ...
    public function show($id)
    {
        ...
        return view('organization.community.show', compact('post'));
    }
