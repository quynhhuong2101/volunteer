        ...
        <div class="bg-blue-600 rounded-3xl p-6 shadow-lg shadow-blue-200 text-white relative overflow-hidden flex flex-col justify-between">
            <div class="relative z-10">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('student.checkin.view') }}" class="block text-center w-full bg-blue-500 bg-opacity-40 text-white py-2.5 rounded-xl font-medium text-sm hover:bg-opacity-50 transition-colors border border-blue-400">
                        Nhập mã thủ công
                    </a>
                </div>
                </div>
